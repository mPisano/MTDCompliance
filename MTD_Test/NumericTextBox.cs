    ...
    public class NumericTextBox : TextBox
    {
        ...
        public int NumericScaleOnLostFocus
        {
            ...
            set
            {
                ...
                if (value >= this.NumericPrecision)
                {
                    MessageBox.Show("Scale cannot be larger than precession!", "Numeric TextBox", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
...
System.ComponentModel.Category("Numeric settings")]
        ...
        {
            get { return (Int32)idec_NumericValue; }
        }
    ...
    System.ComponentModel.Category("Numeric settings")]
        ...
        private void NumericTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == 0x0016 || e.KeyChar == 0x0003) //Copy\Paste Ctrl C\V
            {
                return;
            }
